...
# ==================================================================
#  estimates parameters of GUMBEL-fit to data.
...
#  k    :   shape parameter of GEV (k=0, forced for GUMBEL)
...
#  estim:   what estimator was used (mlik or lmom)
   ...
   # CALCULATE PSTAR AND B VALUES (see Hosking 1990, Eq. 2.3 and p. 114.)
   p00 <-  1
   p10 <- -1
   p11 <-  2
   p20 <-  1
   ...
   # CONSTRUCT NEW OBJECT FOR OUTPUT
   list(data=data.df,
       lamda=lamda,
       alpha=alpha,
       chi=chi,
